...
<script type="text/javascript">
	...
	/** OnLoad event */ 
		...
		function Sclick( bord_code , status ) { 
			...
			var param = { 
			 ...
			 callAjax("/cmp/SclickOrderConfirm.do", "post", "json", true, param, Sclickcallback);
	    }	
...
<form id="myForm" action=""  method="">
	...
	<input type="hidden" id="BORD_CODE" name="BORD_CODE" value =""/>
